...
contract MockERC20 is OZToken,IExtendedERC202{
    constructor() OZToken("MockToken", "MTK"){
...
contract MockERC721 is NFTToken {
    constructor() NFTToken("MockNFT", "MNFT") {}
